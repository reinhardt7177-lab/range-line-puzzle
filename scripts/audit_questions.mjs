...
const optionErrors = allQuestions.filter((question) => !question.input && question.answers.some((answer) => !question.options.includes(answer)));
...
const report = {
  ...
  optionErrors: optionErrors.length,
